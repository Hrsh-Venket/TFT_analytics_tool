...
def main():
    ...
    parser.add_argument('--units-mapping', default='name_mappings/units_mapping.csv',
                       help='CSV file with unit name mappings (default: name_mappings/units_mapping.csv)')
    parser.add_argument('--items-mapping', default='name_mappings/items_mapping.csv', 
                       help='CSV file with item name mappings (default: name_mappings/items_mapping.csv)')
    parser.add_argument('--traits-mapping', default='name_mappings/traits_mapping.csv',
                       help='CSV file with trait name mappings (default: name_mappings/traits_mapping.csv)')
